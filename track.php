...
<head>
  ...
  <title> <?php echo "$title | TRACK ACTIVITIES   "; ?> </title>
                ...
                <div class="card-body">
                  <div class="table-responsive ">
                    <table class="table table-bordered print_mlc " id="all_customer" width="100%" cellspacing="0">
                      <thead>
					  <tr>
                            <th colspan='8' style='text-align:center; font-size:30px;'> TRACK ACTIVITIES  </th>
                        ...
                        <tr>
                           ...
                           <th> KEYWORD</th>
                            ...
                            <tbody>
							       	...
							       	<?php 
					$all_debt_payment = new run_query("select * from   activity_track  ");
